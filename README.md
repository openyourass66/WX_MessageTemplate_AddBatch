...
本项目已打包为 Windows 桌面端应用程序，提供可视化界面。
...
- `微信小程序模板批量工具 x.x.x.exe` — 便携版（无需安装）

### 桌面端功能

- **导出模板** — 配置源小程序 AppID/Secret，导出已有模板配置
- **目标小程序管理** — 可视化编辑需要添加模板的目标小程序列表
- **批量添加** — 选择模板文件和目标列表，支持 Dry-Run 预检查
- **运行日志** — 实时查看脚本执行输出
